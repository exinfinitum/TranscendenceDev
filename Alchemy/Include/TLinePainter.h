...
class ILinePainter
	...
	public:
		...
		virtual void DrawWithOpenGL (CG32bitImage &Dest, int x1, int y1, int x2, int y2, int iRotDegrees, bool& bSuccess, OpenGLRenderLayer::blendMode blendMode, int iWidth, float fScale) { }
	};
